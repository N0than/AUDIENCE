        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <LogOut className={`w-5 h-5 text-white dark:text-gray-900 light-text-gray-900`} />
              </button>
              <button
                onClick={toggleTheme}
                className="p-2 hover:bg-gray-800 dark:hover:bg-gray-200 light-hover:bg-gray-300 rounded-lg transition-colors"
              >
                {theme === 'dark' ? (
                  <Sun className={`w-5 h-5 text-white dark:text-gray-900 light-text-gray-900`} />
                ) : (
                  <Moon className={`w-5 h-5 text-gray-900 dark:text-white light-text-white`} />
                )}
              </button>
            </div>
          </div>
          ...
          {showAdminMenu && (
            <div className="absolute right-20 top-20 bg-gray-800 dark:bg-gray-200 light-bg-gray-200 text-gray-100 dark:text-gray-900 light-text-gray-900 rounded-lg shadow-lg p-4">
